    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutoAssesmentResults", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterfaceLayouts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InterfaceLayouts_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostTextReplies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PostTextReplies_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PostTextReplies_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterfaceLayouts_PostId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_AutoAssessmentId",
                table: "Posts",
                column: "AutoAssessmentId");

            migrationBuilder.CreateIndex(
                name: "IX_PostTextReplies_AuthorId",
                table: "PostTextReplies",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_PostTextReplies_PostId",
                table: "PostTextReplies",
                column: "PostId");
