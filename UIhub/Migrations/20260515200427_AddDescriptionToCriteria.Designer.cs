...
namespace UIhub.Migrations
{
    ...
    [Migration("20260515200427_AddDescriptionToCriteria")]
    partial class AddDescriptionToCriteria
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UIhub.Models.Analysis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UIhub.Models.AnalysisCriteria", b =>
                {
                    ...
                    b.ToTable("AnalysisCriterias");
                });

            modelBuilder.Entity("UIhub.Models.AnalysisFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UIhub.Models.CriteriaIssue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CriteriaResultId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CriteriaResultId");

                    b.ToTable("CriteriaIssues");
                });

            modelBuilder.Entity("UIhub.Models.CriteriaResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AnalysisCriteriaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AnalysisCriteriaId");

                    b.HasIndex("AnalysisFileId");
            ...
            modelBuilder.Entity("UIhub.Models.AnalysisFile", b =>
                {
                    b.HasOne("UIhub.Models.Analysis", "Analysis")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("UIhub.Models.CriteriaIssue", b =>
                {
                    b.HasOne("UIhub.Models.CriteriaResult", "CriteriaResult")
                        .WithMany("Issues")
                        .HasForeignKey("CriteriaResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CriteriaResult");
                });

            modelBuilder.Entity("UIhub.Models.CriteriaResult", b =>
                {
                    b.HasOne("UIhub.Models.AnalysisCriteria", "AnalysisCriteria")
                        .WithMany("Results")
                        .HasForeignKey("AnalysisCriteriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UIhub.Models.AnalysisFile", "AnalysisFile")
                        .WithMany("Results")
                        .HasForeignKey("AnalysisFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AnalysisCriteria");

                    b.Navigation("AnalysisFile");
                });
